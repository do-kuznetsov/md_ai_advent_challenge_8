...
data class ChatViewState(
    ...
    val numCtxInput: String = ApiSettings().numCtx.toString(),
    val topPInput: String = ApiSettings().topP.toString(),
    val seedInput: String = ApiSettings().seed.toString(),
    val repeatPenaltyInput: String = ApiSettings().repeatPenalty.toString(),
