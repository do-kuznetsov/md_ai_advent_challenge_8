...
По умолчанию сервер слушает `http://127.0.0.1:3000/mcp`, клиент подключается туда же и выводит список доступных tools. В выводе клиента должен появиться `visitor_log`.
